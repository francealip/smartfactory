...
class GeneralQAChain:
  def __init__(self, llm, graph, history):
    ...
    template_general_QA_answer = (
        "Task: You are given the results of a SPARQL query that provides information from an ontology of a factory floor. "
        "This data includes details about KPIs, machines, and other relevant entities."
        "Your job is to transform this context into a verbose text that will be used to generate a chat response. "
        "The text should contains the text must contain all the information in a comprehensive manner"
        "The text should consist of short sentences, separated by periods, and must exhaustively cover all the relevant details from the ontology. "
        "The information provided is authoritative. Do not question or correct it with your own knowledge. "
        "If a field contains a hyphen, it signifies that the field is irrelevant or lacks meaningful information, and should be disregarded (e.g., a formula within an atomic KPI). "
        "Use the SPARQL query to interpret and understand the meaning of the fields. "
        "Context: {context} "
        "Query: {query} "
        "Question: {prompt} "
        "Helpful Answer: "
